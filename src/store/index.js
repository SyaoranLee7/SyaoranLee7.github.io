...
let saveStateKeys = ['vuex_user', 'vuex_token', "vuex_magic", "vuex_code", "vuex_share_code", "vuex_mode"];
...
const store = new Vuex.Store({
	state: {
		...
		vuex_list_index: 0,
		vuex_create_order: {},
		vuex_mode: lifeData.vuex_mode ? lifeData.vuex_mode : '',
		vuex_code: lifeData.vuex_code ? lifeData.vuex_code : '',
		vuex_share_code: lifeData.vuex_share_code ? lifeData.vuex_share_code : '',
