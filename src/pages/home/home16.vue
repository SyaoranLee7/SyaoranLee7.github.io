    ...
    <view class="app-home-plan">
      ...
      <!-- <view class="app-home-plan-box" v-if="targetList.length > 0">
        ...
        <view class="app-home-plan-box-list">
          <view class="app-home-plan-box-list-items">血压管理</view>
          <view class="app-home-plan-box-list-items">血糖管理</view>
          <view class="app-home-plan-box-list-items">脂肪肝管理</view>
          <view class="app-home-plan-box-list-items">血压管理</view>
        </view>
      </view> -->
      ...
      <swiper-item v-for="(item,index) of tips" :key="'swiper_'+index">
        <view class="app-home-target">
          ...
          <view class="app-home-target-info">
            ...
            <view class="app-home-target-info-des"
              >{{item.date}}</view
            >
          </view>
        </view>
      ...
      <view class="app-home-calorie">
        <view class="app-home-calorie-box">
          ...
          <view class="app-home-calorie-box-detail">
            <view class="nums"
              >{{ calorie_in }}<view class="unit">千卡</view></view
            >
        ...
        <view class="app-home-calorie-info">
          <view class="app-home-calorie-info-item">
            ...
            <view class="info">
              ...
              <view class="nums"
                >{{ calorie_in }}<span class="unit">千卡</span></view
              >
            </view>
          </view>
          <view class="app-home-calorie-info-item">
            ...
            <view class="info">
              ...
              <view class="nums"
                >{{ calorie_out }}<span class="unit">千卡</span></view
              >
            </view>
          </view>
        </view>
