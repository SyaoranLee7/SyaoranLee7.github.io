  ...
  <view class="ronin-details-new">
    <view class="head">
      <view class="head-content">
        <view class="title">健康运动提醒</view>
        <view class="des"
          >每天适当进行运动，能够使体内各个器官功能得到提升，达到使机体更加健康的作用。</view
        >
        <u-image
          class="img"
          width="228rpx"
    ...
    <view class="card">
        ...
        <view class="product-item">
          <view class="product-content">
            ...
            <view class="product">
              ...
              <view class="price"
                >{{ item.remark }} 消耗{{ item.calorie }}大卡/60分钟
              </view>
            </view>
     ...
     <view class="warp" v-if="show">
      <view class="warp-box">
        ...
        <view class="warp-box-title">恭喜您</view>
        <view class="warp-box-des">本次消耗{{calorie}}大卡</view>
...
import { querySports } from "@/api/service";
export default {
  data() {
    return {
      list: [],
  ...
  methods: {
    ...
    records() {
      ...
      let content = [
        {
          DATA_H_CALORIE_CONSUME: calorie,
        },
      ];
      for (let v of this.list) {
        if (v.check) {
      ...
      let params = {
        content: content,
        mdTableId: "MTC1604466332371001344", //todo:写死的要放入config
        remark: "",
        taskId: this.taskId,
      };
