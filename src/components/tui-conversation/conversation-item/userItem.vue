<template>
	<!--TODO: 默认图片在 cos 上添加 -->
	<movable-area v-if="conversation.userID" class="t-conversation-item-container">
		<movable-view class="t-conversation-item" direction="horizontal" @change="handleTouchMove" damping="100" :x="xScale">
			<view class="avatar-box">
				<image class="t-conversation-item-avatar" src="https://sdk-web-1252463788.cos.ap-hongkong.myqcloud.com/component/TUIKit/assets/avatar_21.png" ></image>
			
			</view>
			<view class="t-conversation-item-content">
				<label class="tui-conversation-item-name">{{ conversation.profile.nick }}</label>
